...
""")
    print("╔════════════════════════════════════════╗")
    print(f"║{P}[{H}•{P}] Author    : MR™UMER KHAN          {N}║")
    print(f"║{P}[{H}•{P}] Whatsapp  : 0093764894567        {N}║")
    print(f"║{P}[{H}•{P}] Github    : UMER KHAN{N}  ║")
    
    print(f"║{P}[{H}•{P}] Support   : 32 & 64              {N}║")
    print(f"║{P}[{H}•{P}] STATU     : FREE
    print(f"║{P}[{H}•{P}] SC Version: V-1.1      {N}║")
    print("╚════════════════════════════════════════╝")
#CRACK SELESAI
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        ...
        if cek_cp =="":
            ...
            if ww in ("Y","y","ya"):
                ubahP.append("y")
                print(f" {N}[{H}•{N}] Password example : {U}UMER KHAN {N}")
                pwBar=input(f" {N}[{K}?{N}] Enter new password : {U}")
                #print("\n")
                if len(pwBar) <= 5:
